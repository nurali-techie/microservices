...
type GetRestaurantReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetRestaurantReply) Reset() {
	*x = GetRestaurantReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetRestaurantReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetRestaurantReply) ProtoMessage() {}

func (x *GetRestaurantReply) ProtoReflect() protoreflect.Message {
	mi := &file_proto_model_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetRestaurantReply.ProtoReflect.Descriptor instead.
func (*GetRestaurantReply) Descriptor() ([]byte, []int) {
	return file_proto_model_proto_rawDescGZIP(), []int{1}
}

func (x *GetRestaurantReply) GetID() string {
	if x != nil {
		return x.ID
	}
	return ""
...
func (x *GetRestaurantReply) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *GetRestaurantReply) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
func (x *GetRestaurantReply) GetCity() string {
	if x != nil {
		return x.City
	}
	return ""
...
var file_proto_model_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x26, 0x0a, 0x14, 0x47, 0x65,
	...
	0x49, 0x44, 0x22, 0x66, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x52, 0x65, 0x73, 0x74, 0x61, 0x75, 0x72,
	0x61, 0x6e, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x0e, 0x0a, 0x02, 0x49, 0x44, 0x18, 0x01,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x43, 0x69, 0x74, 0x79, 0x32, 0x58, 0x0a, 0x0b, 0x4d, 0x65,
	0x6e, 0x75, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x49, 0x0a, 0x0d, 0x47, 0x65, 0x74,
	0x52, 0x65, 0x73, 0x74, 0x61, 0x75, 0x72, 0x61, 0x6e, 0x74, 0x12, 0x1b, 0x2e, 0x70, 0x72, 0x6f,
	...
	0x47, 0x65, 0x74, 0x52, 0x65, 0x73, 0x74, 0x61, 0x75, 0x72, 0x61, 0x6e, 0x74, 0x52, 0x65, 0x70,
	0x6c, 0x79, 0x22, 0x00, 0x42, 0x44, 0x5a, 0x42, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	0x6f, 0x6d, 0x2f, 0x6e, 0x75, 0x72, 0x61, 0x6c, 0x69, 0x2d, 0x74, 0x65, 0x63, 0x68, 0x69, 0x65,
	0x2f, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2f, 0x63,
	0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x73, 0x2d, 0x67, 0x6f, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e,
	0x73, 0x5f, 0x67, 0x6f, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_proto_model_proto_goTypes = []interface{}{
	(*GetRestaurantRequest)(nil), // 0: proto.GetRestaurantRequest
	(*GetRestaurantReply)(nil),   // 1: proto.GetRestaurantReply
}
var file_proto_model_proto_depIdxs = []int32{
	0, // 0: proto.MenuService.GetRestaurant:input_type -> proto.GetRestaurantRequest
	1, // 1: proto.MenuService.GetRestaurant:output_type -> proto.GetRestaurantReply
...
func file_proto_model_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_model_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetRestaurantReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
